...
if (document.getElementById("evidenceSearch")) document.getElementById("evidenceSearch").value = "";
  if (document.getElementById("filterType")) document.getElementById("filterType").value = "";
  if (document.getElementById("filterPerson")) document.getElementById("filterPerson").value = "";
  if (document.getElementById("filterLocation")) document.getElementById("filterLocation").value = "";
  if (document.getElementById("filterStatus")) document.getElementById("filterStatus").value = "";
  if (document.getElementById("filterRelevance")) document.getElementById("filterRelevance").value = "";
  renderEvidenceList();
}
