...
export function renderTimeline() {
  ...
  var orderElem = document.getElementById("timelineOrder");
  var personElem = document.getElementById("timelinePersonFilter");
  var locationElem = document.getElementById("timelineLocationFilter");
  var typeElem = document.getElementById("timelineTypeFilter");

  var order = orderElem ? orderElem.value : "asc";
  var personFilter = personElem ? personElem.value : "";
  var locationFilter = locationElem ? locationElem.value : "";
  var typeFilter = typeElem ? typeElem.value : "";
