...
export function saveHypothesis() {
  ...
  const evidenceElem = document.getElementById("hypEvidence");
  const confidenceElem = document.getElementById("hypConfidence");
  const explanationElem = document.getElementById("hypExplanation");
  const alternativeElem = document.getElementById("hypAlternative");
...
export function loadHypothesisFromStorage() {
  ...
  const natureElem = document.getElementById("hypNature");
  const confidenceElem = document.getElementById("hypConfidence");
  const confidenceValElem = document.getElementById("hypConfidenceValue");
  const explanationElem = document.getElementById("hypExplanation");
  const alternativeElem = document.getElementById("hypAlternative");
